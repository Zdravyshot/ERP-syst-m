...
export function OrderForm({
  ...
  return (
    <form action={formAction} className="max-w-3xl space-y-5 rounded-xl border border-gray-200 bg-white p-6">
      ...
      <div>
        <div className="mb-2 flex items-center justify-between">
          ...
          <button
            ...
            className="rounded-lg border border-gray-300 px-3 py-1 text-sm text-gray-700 transition hover:bg-gray-50"
          >
            + Pridať položku
          </button>
        </div>
